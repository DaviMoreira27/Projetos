...
if ($login->issetLogin($_POST['email'], $_POST['senha'])
...
//    EXITO - Ir para a pagina administrativa
    ...
    $pg = $manager->selectWhere(2, $arrayParams,
        $arrayParamsPost, 'login');
    if ($pg){
        ...
        ?>
        <form action="../view/listaprodutos.php" name="myForm" id="myForm"
              method="post">
